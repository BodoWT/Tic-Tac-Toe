...
function checkWin() {
    for (let i = 0; i < winPos.length; i++) {
      //  le document.getElementById(pos) recpère l'ellement dans chaque case de condition de victoire
      // me déclarele "symbols"utilisant la méthode map qui parcourt chaque position de victoire et récupère le contenu HTML de l'élément correspondant à chaque position
